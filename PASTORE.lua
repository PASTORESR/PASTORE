...
if DevPASTOREW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/PASTORESR/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/PASTORESR/Files_PASTORE/main/File_Bot/"..file)
if res == 200 then
