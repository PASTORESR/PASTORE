...
os.execute('wget https://raw.githubusercontent.com/PASTORESR/PASTORE/main/PASTORE.lua')
...
if DevPASTOREW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/PASTORESR/File_Bot/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/PASTORESR/File_Bot/main/File_Bot/"..file)
if res == 200 then
...
{
{text = '𝑷𝑨𝑺𝑻𝑶𝑹𝑬 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/ieeo3s"},
},
}
